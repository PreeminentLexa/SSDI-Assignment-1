...
public class TripleBarrelShotgun extends WeaponData {
    /** getName() - Psudo getter for the name of this Weapon
     * @return A String, the name
     */
    public String getName(){return "Triple Barrel Shotgun";}
     ...
     */
    public float getROF(){return 0.75f;}
     ...
     */
    public int getMaxClip(){return 3;}
    ...
    public static Weapon create(){
        return new WeaponRanged(new TripleBarrelShotgun());
    }
}
